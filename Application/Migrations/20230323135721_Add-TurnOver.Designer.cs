...
namespace Application.Migrations
{
    ...
    [Migration("20230323135721_Add-TurnOver")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Application.Model.TurnOvers", b =>
                {
                    b.Property<string>("id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Application.Model.TurnOvers", b =>
                {
                    b.HasOne("Application.Model.EventType", "eventType")
                        .WithMany()
                        .HasForeignKey("eventTypeid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Application.Model.PointState", "state")
                        .WithMany()
                        .HasForeignKey("stateid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Application.Model.TransactionType", "transactionType")
                        .WithMany()
